    ...
    <>
      ...
      >
            ...
            {menus.map((menu, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`font-medium whitespace-nowrap transition-all ${isOpen ? "opacity-100 block" : "opacity-0 hidden"}`}>
                    {menu.name}
                  </span>
                </li>
              )
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-3 text-white/80 hover:text-white rounded-xl transition-all group"
        >
          <LogOut size={20} className="min-w-[20px] group-hover:translate-x-1 transition-transform" />
          ...
          <div className="relative bg-white rounded-3xl w-full max-w-[320px] p-6 shadow-2xl animate-in zoom-in duration-200">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div className="flex w-full gap-3 pt-4">
                <Button 
                  variant="outline" 
                  className="flex-1 rounded-2xl border-gray-200 text-gray-600 font-semibold py-6"
                  onClick={() => setShowLogoutConfirm(false)}
                >
                  Batal
                </Button>
                <Button 
                  className="flex-1 bg-red-500 hover:bg-red-600 text-white rounded-2xl font-semibold py-6 shadow-lg shadow-red-200 transition-all"
